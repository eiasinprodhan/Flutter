...
class _AddEmployeeScreenState extends State<AddEmployeeScreen> {
  ...
  String selectedRole = AppConstants.roles.first;
  String selectedSalaryType = AppConstants.salaryTypes.first;
  String selectedCountry = AppConstants.countries.first;
  ...
  Future<void> _saveEmployee() async {
    ...
    try {
      ...
      final success = await provider.addEmployee(user, employee, selectedImage);
      ...
      if (mounted) {
        if (success) {
          ...
          _showSnackBar(provider.errorMessage ?? 'Failed to add employee', isError: true);
        }
      }
    } catch (e) {
      print('Exception in _saveEmployee: $e');
      if (mounted) {
